...
crontab 每天在跑的命令有 5 个，post 下的 4 个命令：upload_hotposts_to_db、upload_posts_to_db、upload_yuce_to_db、upload_zhili_to_db 和 data_analysis 下的 update_history_data_to_zky_es 命令。  
